...
Como puede observarse en la evaluación de los proyectos que se mostrará a continuación, para los diferentes proyectos evaluados, el proyecto que más puntuación obtiene es RethinkDB, 2.14. En segundo lugar aparece el proyecto ArangoDB, con una puntuación de 1.5, mientras que MongoDB obtiene una puntuación de 1.25.

La puntuación de cada uno de los proyectos, clasificadas por categorías, junto a las métricas de cada una de éstas y la ponderación de las mismas es la que se muestra a continuación:
...
\begin{table}[H]
  \begin{center}
    ...
    \hline
    Anchura de líneas de código & Existen ficheros con anchura mayor a 120 & 0 & 33.33\% & 0\\
    \hline
    Existencia de tabuladores & Existe código identado con tabuladores & 0 & 33.33\% & 0\\
    \hline
    Nombrado de variables & Existen variables con nombres como 'l' o 'O' & 0 & 33.33\% & 0\\
    \midrule
...
\begin{table}[H]
  \begin{center}
    ...
    Código Duplicado & Existe código duplicado de entre 100 y 500 tokens & 3 & 33.33\% & 1\\
    \midrule
    \textbf{Puntuación} & \multicolumn{4}{c|}{\textbf{2.67}}\\
    \hline
    \textbf{Puntuación ponderada (33.33\%)} & \multicolumn {4}{c|}{\textbf{0.89}}\\
    \midrule
    \multicolumn{5}{|c|}{\textbf{Métricas Formato de Código}}\\
    \hline
    Anchura de líneas de código & Existen ficheros con anchura mayor a 120 & 0 & 33.33\% & 0\\
    ...
    \textbf{Puntuación ponderada (33.33\%)} & \multicolumn {4}{c|}{\textbf{0}}\\   
    \midrule
    \multicolumn{5}{|c|}{\textbf{Puntuación total: 1.25 + 0.89 + 0 = \hl{2.14}}}\\
    \bottomrule
    \end{tabular}
...
Análisis de calidad con histórico de tiempo.
Modificación de herramientas para extracción de métricas.
Comparativa entre iteraciones de modelos de calidad.
