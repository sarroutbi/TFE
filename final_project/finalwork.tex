...
\begin{table}[H]
  \begin{center}
    ...
    & & Existe Código Duplicado de entre 500 y 1000 tokens& 2 \\ \cline{3-3}\cline{4-4}
    & & Existe Código Duplicado de más de 1000 tokens & 0 \\ \cline{3-3}\cline{4-4}
    \bottomrule
    \end{tabular}
...
\begin{table}[H]
  \begin{center}
    ...
    & & Existen líneas de más de 100 caracters, pero ninguna de más de 120 & 3 \\ \cline{3-3}\cline{4-4}
    & & Existen líneas de más de 120 caracteres & 0 \\ \cline{3-3}\cline{4-4}
    \hline
